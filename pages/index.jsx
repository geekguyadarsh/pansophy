    ...
    <>
      ...
      <main>
        <div className="flex">
          ...
          <div className="w-full px-4 py-10 overflow-hidden md:mx-8 top-10">
            ...
            <div className="flex flex-wrap items-center justify-center gap-6 md:justify-between md:flex-nowrap">
              <div className="relative w-full">
                <input
                  type="text"
                  className="min-w-full px-4 py-3 text-xs bg-[#0c0d0f] border-[#16191F] rounded-md focus:outline-none placeholder-[#6C757D]"
            ...
            {/* SUPPPPPPPPP */}
            <div className="mt-6 overflow-x-scroll rounded-md ">
              <table className="divide-y divide-[#16191F] md:w-screen lg:w-full border border-[#16191F]">
                ...
                <tbody className="bg-[#0C0D0F] divide-y divide-[#16191F]">
                  {dataset.map((data, i) => (
                    <tr key={i}>
                      ...
                      <td className="px-4 py-4 whitespace-nowrap">
                        <span
                          className={`inline-flex px-2 py-1 text-xs leading-5 
                        ${
                          data.status == 0 &&
